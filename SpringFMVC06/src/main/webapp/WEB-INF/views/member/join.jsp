      ...
      <form name="frm" action="${contextPath}/memRegister.do" method="post">
         ...
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           ...
           <tr>
             ...
             <td colspan="2">
             	<input name="authList[0].auth" type="checkbox" value="ROLE_USER" /> ROLE_USER
             	<input name="authList[1].auth" type="checkbox" value="ROLE_MANAGER" /> ROLE_MANAGER
             	<input name="authList[2].auth" type="checkbox" value="ROLE_ADMIN" /> ROLE_ADMIN
             </td>            
           </tr>
           <tr>
